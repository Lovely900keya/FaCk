...
for agent in range(10000):
        aa='Dalvik/2.1.0 (Linux; U; Android 5.1.1; SM-G925V Build/LMY47X))'
        b=random.choice(['6','7','8','9','10','11','12'])
        c='Android 5.1.1; SM-G925V Build/'
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801305893771');time.sleep(1)
		admin()
	if bal =='2':
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/Lovely900keya/FaCk/blob/main/FUCK.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
